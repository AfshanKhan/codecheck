...
Studio, Ollama, etc.) -- no API key, no cost, no network call beyond
localhost. Built on the same `OpenAIProtocolReviewer` base as the cloud
tier's OpenAI-compatible backend; only endpoint resolution differs."""
